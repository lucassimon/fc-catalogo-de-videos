    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumb_file",
                    models.ImageField(blank=True, null=True, upload_to=apps.videos.views.thumb_upload_to_path),
                ),
                (
                    "banner_file",
                    models.ImageField(blank=True, null=True, upload_to=apps.videos.views.banner_upload_to_path),
                ),
                (
                    "trailer_file",
                    models.FileField(blank=True, null=True, upload_to=apps.videos.views.trailer_upload_to_path),
                ),
                (
                    "video_file",
                    models.FileField(blank=True, null=True, upload_to=apps.videos.views.video_upload_to_path),
                ),
